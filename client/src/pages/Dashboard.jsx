    ...
    return (
        <div className="flex flex-col w-full h-full p-10 space-y-10">
            <div className="flex flex-col space-y-1">
                <h1 className="text-3xl font-bold">Welcome to FdOrg</h1>
                <p>This will serve as the base project file for my Feedback Organizer app using Semantic Detection and Zero-Shot Classification models</p>
